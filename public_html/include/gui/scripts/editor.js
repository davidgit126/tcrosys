...
function InnovaEditor(oName)
  ...
  */
  ...
  this.tabs=[
  ["tabHome", "Main", ["grpEdit", "grpMisc", "grpFont", "grpPara", "grpInsert", "grpTables", "grpMedia"]]
 /* ["tabStyle", "Objects", ["grpMedia", "grpMisc"]]*/
  ];

  this.groups=[
  ["grpEdit", "", ["Save", "Undo", "Redo", "FullScreen", "RemoveFormat", "BRK", "Cut", "Copy", "Paste", "PasteWord", "PasteText","XHTMLFullSource"]],
  ["grpFont", "", ["FontName", "FontSize", "Styles", "BRK", "Bold", "Italic", "Underline", "Strikethrough", "Superscript","Subscript" , "ForeColor", "BackColor"]],
  ...
  ["grpTables", "", ["Table","Guidelines", "BRK", "Absolute","Characters","Line"]],
...
function ddAction(tb, id, edt, sfx) {
  ...
  switch(btn) {
    ...
    case "mnuTableEdit": modelessDialogShow(e.scriptPath+"table_edit.htm",400,395); break;
