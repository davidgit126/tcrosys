...
function RENDER(sPreloadHTML, dvId)
  ...
  if(this.mode=="XHTML"){this.btnXHTMLFullSource=true;this.btnXHTMLSource=false;}
    ...
    sHTML+="<table id='cntContainer"+this.oName+"' cellpadding=0 cellspacing=0 width='100%' height='100%' style='margin-top:1px;'><tr style='width:100%;height:100%'><td width='100%' height='100%' style='padding:0px;border:solid 1px #cfcfcf;'>";//StyleSelect
...
function loadHTMLFull(sHTML, firstLoad)//first load full HTML
    ...
    sHTML = sHTML.replace(reg, "<head></head>");
    ...
    var head = de.getElementsByTagName("HEAD");
    if(head.length>0) {
      head = head[0];
      //var allLinks = head.getElementsByTagName("LINK"), l;
      //var linksCount = allLinks.length;
      ...
      //  objL.href=l.href;
      //  objL.rel="StyleSheet";
      //  head.appendChild(objL);
      //  alert(l.href);
      //}
      
      //setTimeout(function() {head.innerHTML = head.innerHTML}, 100);
      
      setTimeout(function() {head.innerHTML = hcnt}, 100);
    ...
    objL.href=this.scriptPath+"default_edit.css";
    objL.rel="StyleSheet";
    de.childNodes[0].appendChild(objL);
