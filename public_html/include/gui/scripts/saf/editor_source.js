...
function InnovaEditor(oName)
  ...
  */
  ...
  this.tabs=[
  ["tabHome", "Main", ["grpEdit", "grpFont", "grpPara","grpInsert", "grpTables", "grpMedia"]],
  ];
  ...
  ["grpMisc", "", ["Characters", "Line", "Preview", "BRK", "CustomTag"]]
  ];
    ...
    //*** CMS FUNCTIONS ***
  this.cmdAssetManager="/assetmanager/assetmanager.asp";
  
  this.cmdFileManager="/assetmanager/assetmanager.asp";
  this.cmdImageManager="/assetmanager/assetmanager.asp";
  this.cmdMediaManager="/assetmanager/assetmanager.asp";
  this.cmdFlashManager="/assetmanager/assetmanager.asp";
...
function RENDER(sPreloadHTML, dvId)
  ...
  iconHeight=this.iconHeight;
    ...
    if(sPreloadHTML.substring(0,4)=="<!--" && sPreloadHTML.substring(sPreloadHTML.length-3)=="-->")
      sPreloadHTML=sPreloadHTML.substring(4,sPreloadHTML.length-3);

  if(sPreloadHTML.substring(0,4)=="<!--" && sPreloadHTML.substring(sPreloadHTML.length-6)=="--&gt;")
  ...
  if(this.mode=="XHTML"){this.btnXHTMLFullSource=true;this.btnXHTMLSource=false;}
    ...
    sHTML+="<table id=idArea"+this.oName+" name=idArea"+this.oName+" border='0px' "+
            "cellpadding=0 cellspacing=0 width='"+this.width+"' height='"+this.height+"' style='border-bottom:solid 1px #cfcfcf'>"+
    ...
    sHTML+="<iframe frameborder='no' style='width:100%;height:100%;' "+
...
function ddAction(tb, id, edt, sfx) {
  ...
  switch(btn) {
    ...
    case "mnuCellEdit": modelessDialogShow(e.scriptPath+"table_editCell.htm",431,445); break;
